    ...
    <div>
        <div ref="slider" class="keen-slider h-[670px]">
            <div class="keen-slider__slide number-slide1">
                <img id="#image1" class="object-cover h-full w-full" :src="require('@/assets/men.jpg')" />
            </div>
            <div id="keen-slider__slide" class="keen-slider__slide number-slide2">
                <img id="#image11" class="object-contain h-full w-full   bg-gradient-to-b from-orange-500 to-yellow-300"
                    :src="require('@/assets/image50.png')" />
            </div>
            <div id="keen-slider__slide3" class="keen-slider__slide number-slide3">
                <img id="#image13" class="object-contain h-full w-full sm:w-full  md:w-full bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))] from-fuchsia-300 via-green-400 to-rose-700"
