  ...
  <nav class="p-8 w-full">
    <div class="container mx-auto flex justify-between items-center">
      ...
      <div class="flex text-xs items-center">
        <router-link to="/" class="text-white font-bold text-xl pr-4"
        ...
        >
        <router-link to="/CreateSkipa" class="hidden md:block text-gray-400 px-4"
          >Create your own Skipa
        </router-link>
      </div>
      ...
      <!-- Search Bar -->
      <div
        class="font-bold text-gray-400 flex items-center md:place-items-stretch md:flex-col"
      >
    ...
    >
      <hr
        class="w-full h-[1px] mx-auto my-4 bg-black border-0 rounded md:my-10 dark:bg-gray-700"
      />
      <router-link to="LatestArrivals" class="block text-xs py-2 px-4 text-gray-700"
        >Latest arrival</router-link
      >
      <router-link to="/about" class="block py-2 text-xs px-4 text-gray-700"
        >Create your own Skipa</router-link
      >
      <router-link to="AllTshirt" class="block text-xs py-2 px-4 text-gray-700"
        >all T-shirt</router-link
      >
      <router-link to="/ClientLogin" class="block py-2 text-xs px-4 text-gray-700"
        >Login</router-link
      >
      <router-link to="CreateAccount" class="block text-xs py-2 px-4 text-gray-700"
        >Signup</router-link
      >
      ...
      <button
        @click="closeMenu"
        @mouseover="rotateElement"
        @mouseleave="resetRotation"
        class="rotate-element absolute h-10 hover:text-black hover:scale-110 hover:rotate-360 duration-500 shadow-2xl w-30 p-5 top-0 right-0 m-20 bg-gradient-to-r rounded-lg from-indigo-300 to-purple-400 text-white flex items-center justify-center"
      >
        <!-- You can use an icon or text for the button, for example: -->
        X
      </button>
      <!-- E-commerce Link in Mobile Menu -->
    </div>
  </nav>
</template>
