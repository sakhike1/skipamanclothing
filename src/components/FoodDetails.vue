<template>
    <div class=" bg-gradient-to-r from-slate-500 to-yellow-100  dark:bg-gray-800 py-8">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 bg-gradient-to-r from-slate-70 to-yellow-70 rounded-lg lg:px-8">
            <div class="flex flex-col md:flex-row -mx-4 ">
                <div class="md:flex-1 px-8  p-10">
                    <div
                        class="h-[460px] rounded-lg bg-gradient-to-r from-gray-400 via-gray-600 to-blue-800 dark:bg-gray-700 mb-4 flex justify-center items-center">
                        <img class="object-contain max-h-[290px] w-96 hover:scale-125 " :src="details.url"
                            alt="Product Image">
                    </div>
                    <div class="flex -mx-2 mb-4">
                        <div class="w-full md:w-1/2 px-2 mb-2 md:mb-0">
                            <button v-on:click="goToCart"
                                class="w-full hover:scale-105   bg-gradient-to-r from-slate-500 to-yellow-100 dark:bg-gray-600 text-white py-2 px-4 rounded-full  hover:bg-gray-800 dark:hover:bg-gray-700">View
                                cart items
                            </button>
                        </div>
                        <div class="w-1/2 px-2">
                            <button v-on:click="addToCart"
                                class="w-full hover:scale-105 bg-gradient-to-r from-slate-500 to-yellow-100 dark:bg-gray-700 text-white dark:text-white py-2 px-4 rounded-full  hover:bg-gray-300 dark:hover:bg-gray-600">
                                Add items</button>
                        </div>
                        <div class="w-1/2 px-2">
                ...
                <div class="md:flex-1 px-4 p-10">
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">{{ details.name }}</h2>
                    <p class="text-gray-600 dark:text-gray-300 text-sm mb-4">
                        {{ details.desc }}
                    </p>
                    <div class="flex mb-4">
                        <div class="mr-4">
                            <span class="font-bold text-gray-700 dark:text-gray-300">R{{ details.price }}</span>
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 text-xs mt-2">
                            Made to withstand the test of time, Skipaman T-shirts boast a superior craftsmanship that sets
                            them apart
                            from the rest. Whether you're dressing up for a casual outing or seeking everyday comfort, these
                            T-shirts
